...
import SimpleToken from '/Users/ithihasreddy/Downloads/uniswap-interface-main-2/src/abis/erc20.json'
import getWeb3 from  '/Users/ithihasreddy/Downloads/uniswap-interface-main-2/src/components/Web3Status/getWeb3.js'
...
export default function Swap({ history }: RouteComponentProps) {
  ...
  const runExample = async () => {
    const TestTokenAddress = "0x0000000000095413afC295d19EDeb1Ad7B71c952"

    const detectEthereum = async () =>{
      return await detectEthereumProvider();
        }
        const provider = detectEthereum;
    ...
    try {
      ...
      const instance = new web3.eth.Contract(SimpleToken, TestTokenAddress);

      const tx = await instance.methods
        .approve(
          "0x637587435ceDEED0b92CC856B882Ee705128A5b7",
